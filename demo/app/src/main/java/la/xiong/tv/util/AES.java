...
//	}
	...
	public static String decryptResponse(String content){
		String result = null;
		String str = new String(Base64.decode(new String(Base64.decode(content.getBytes(),0)).getBytes(),0));
		String substring = str.substring(0, str.indexOf("::"));
		result = decryptResponse(b("2018102000000001").substring(0,16), str.substring(str.indexOf("::") + 2),Base64.decode(substring.getBytes(),0));

		return result;
	}

	public static String encryptRequest(String content){
		String str4 = "";


		int i = 0;
		String substring = b("2018102000000001").substring(0, 16);
		String str2 = "";
		while (i < 16) {
		...
		try {
			...
			str4 = new String(Base64.encode(instance.doFinal(str3.getBytes("UTF-8")),0));
		...
		return new String(Base64.encode(new String(Base64.encode((str4 + "::" + str2).getBytes(), 2)).getBytes(),3));
...
//		System.out.println("PKCS7Padding 解密: \n" + decode3);
        ...
        //String cccc = "";
		//String bbbb = decryptResponse(aaaa);
		//System.out.println("bbbb解密: \n" + bbbb);

		//String result = "F2tfdtQMTP/30PTcAMXf3QZ4CoW6annaLzvjGsCN7ztsx5aWxMkO1Hg6CkfRJtYdosrY4i8FvqoH/4IuZQSctMi4n40M0lov1ToceYFZ9SCLpInpkiEBS7jNxKMUOUjUcxXKF1BHcErRALzdvTIrsHCXvhln0V77qKvEe18BjwM=::R3X5gVPL15ReAtxG";
